...
public class DummyController {
	...
	//save함수는 id를 전달하면 해당 id에 대한 데이터에 있으면 update를 해주고
	...
	public User detail(@PathVariable int id) {
		...
		// 요청 : 웹 브라우저
		// user 객체 = 자바 오브젝트
		// 변환 (웹브라이저가 이해할 수 있는 데이터)->json
		// 스프링부트 MessageConverter라는 애가 응답시에 자동 작동
		// 만약에 자바 오브젝트를 리턴하게 되면 MessageCoverter가 Jackson 라이브러리를 호출해서
